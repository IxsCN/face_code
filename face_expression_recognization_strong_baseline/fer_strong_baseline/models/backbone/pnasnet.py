...
class Cell(CellBase):
    ...
    def __init__(self, in_channels_left, out_channels_left, in_channels_right,
        ...
        # the output of ImbalancedDatasetSampling cell approximately by ImbalancedDatasetSampling factor of 2.
        stride = 2 if is_reduction else 1

        # If `match_prev_layer_dimensions` is set to `True`
        # `FactorizedReduction` is used to reduce the spatial size
        # of the left input of ImbalancedDatasetSampling cell approximately by ImbalancedDatasetSampling factor of 2.
