...
def fbresnet18(num_classes=1000):
    """Constructs ImbalancedDatasetSampling ResNet-18 models.

    Args:
        pretrained (bool): If True, returns ImbalancedDatasetSampling models pre-trained on ImageNet
    """
...
def fbresnet34(num_classes=1000):
    """Constructs ImbalancedDatasetSampling ResNet-34 models.
...
def fbresnet50(num_classes=1000):
    """Constructs ImbalancedDatasetSampling ResNet-50 models.
...
def fbresnet101(num_classes=1000):
    """Constructs ImbalancedDatasetSampling ResNet-101 models.
...
def fbresnet152(num_classes=1000, pretrained='imagenet'):
    """Constructs ImbalancedDatasetSampling ResNet-152 models.
